...
## [2026-08-20] Roadmap refresh against shipped client

- Event: FeatureBuilt
- Actions performed: Rewrote `docs/ROADMAP.md` to match the live Phaser client (combat/skills/telegraphs/loot, all-10-map greybox, iOS v1, unenforced `requiredLevel`, no mine boss/job UI/courier warp UI). Synced companion status in `docs/01_PROJECT_MEMORY.md`, `docs/14_SESSION_HANDOFF.md`, `docs/GODS_EYE_REPO_OVERLAY.md`, `docs/world/HEARTHLIGHT_VALE_LAYOUT.md` art/acceptance checklists, and README status. No gameplay code changed.
- Files created: none
- Files modified: `docs/ROADMAP.md`, `docs/01_PROJECT_MEMORY.md`, `docs/14_SESSION_HANDOFF.md`, `docs/GODS_EYE_REPO_OVERLAY.md`, `docs/world/HEARTHLIGHT_VALE_LAYOUT.md`, `README.md`, `docs/ledgers/BUILD_LEDGER.md`
- Dependencies added: none
- Reasoning: The July 1 roadmap still described combat as an unmerged PR and Phase C as empty, which would send the next agent to rebuild systems that already exist
- Verification: documentation-only; checkboxes traced to `WorldScene.transitionToPortal`, `STARTING_JOB_ID`, `maps.ts` portal graph, `regions.ts` warpTable, `data/collision/*.json`, and session handoff dates
- Confidence: 93/100
